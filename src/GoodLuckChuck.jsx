...
// Chuck the Goose Component 🪿 - Matches the logo style!
const Chuck = ({ color = '#C9D943', mood = 'normal', accessory = 'none', size = 100, onClick, showMotion = false }) => {
  const accs = {
    // Classic accessories
    crown: <polygon points="50,2 42,14 46,11 50,0 54,11 58,14" fill={C.gold} stroke={C.forest} strokeWidth="1.5"/>,
    bow: <g><ellipse cx="38" cy="12" rx="7" ry="4" fill={C.pink}/><ellipse cx="62" cy="12" rx="7" ry="4" fill={C.pink}/><circle cx="50" cy="12" r="3" fill={C.pink}/></g>,
    beret: <g><ellipse cx="50" cy="14" rx="16" ry="5" fill={C.purple}/><ellipse cx="50" cy="10" rx="11" ry="9" fill={C.purple}/><circle cx="50" cy="4" r="3" fill={C.purple}/></g>,
    gradcap: <g><rect x="34" y="10" width="32" height="4" fill={C.forest}/><polygon points="50,2 30,10 50,16 70,10" fill={C.forest}/><line x1="66" y1="10" x2="70" y2="18" stroke={C.gold} strokeWidth="2"/><circle cx="70" cy="20" r="2.5" fill={C.gold}/></g>,
    ...
    headphones: <g><path d="M32,30 Q30,18 40,10 Q50,5 60,10 Q70,18 68,30" fill="none" stroke={C.forest} strokeWidth="3"/><rect x="26" y="26" width="8" height="12" rx="3" fill={C.purple}/><rect x="66" y="26" width="8" height="12" rx="3" fill={C.purple}/></g>,
    halo: <ellipse cx="50" cy="4" rx="18" ry="5" fill="none" stroke={C.gold} strokeWidth="3" opacity="0.8"/>,
    horns: <g><path d="M36,16 Q32,4 38,0 Q40,10 38,16" fill={C.red}/><path d="M64,16 Q68,4 62,0 Q60,10 62,16" fill={C.red}/></g>,
    
    // Seasonal costumes
    santa: <g><ellipse cx="50" cy="10" rx="16" ry="7" fill="#cc0000"/><ellipse cx="50" cy="7" rx="18" ry="3" fill="white"/><circle cx="68" cy="6" r="5" fill="white"/></g>,
    witch: <g><polygon points="50,-2 37,18 63,18" fill="#1a1a1a"/><ellipse cx="50" cy="18" rx="16" ry="4" fill="#1a1a1a"/><rect x="47" y="18" width="6" height="2" fill={C.gold}/></g>,
    bunny: <g><ellipse cx="42" cy="4" rx="5" ry="14" fill={C.pink}/><ellipse cx="58" cy="4" rx="5" ry="14" fill={C.pink}/><ellipse cx="42" cy="6" rx="2.5" ry="9" fill="#ffcccc"/><ellipse cx="58" cy="6" rx="2.5" ry="9" fill="#ffcccc"/></g>,
    turkey: <g><ellipse cx="50" cy="4" rx="3" ry="7" fill="#cc0000"/><ellipse cx="43" cy="7" rx="5" ry="10" fill="#ff6600"/><ellipse cx="57" cy="7" rx="5" ry="10" fill="#ff6600"/><ellipse cx="37" cy="10" rx="4" ry="8" fill="#8B4513"/><ellipse cx="63" cy="10" rx="4" ry="8" fill="#8B4513"/></g>,
    shamrock: <g><circle cx="45" cy="6" r="5" fill="#228B22"/><circle cx="55" cy="6" r="5" fill="#228B22"/><circle cx="50" cy="11" r="5" fill="#228B22"/><rect x="48" y="13" width="4" height="8" fill="#228B22"/></g>,
    party: <g><polygon points="38,16 42,0 50,16" fill={C.pink}/><polygon points="50,16 54,0 62,16" fill={C.gold}/><circle cx="42" cy="2" r="2.5" fill={C.lime}/><circle cx="54" cy="2" r="2.5" fill={C.purple}/></g>,
    
    // Funny costumes
    cowboy: <g><ellipse cx="50" cy="16" rx="22" ry="5" fill="#8B4513"/><ellipse cx="50" cy="10" rx="12" ry="9" fill="#8B4513"/><ellipse cx="50" cy="12" rx="9" ry="5" fill="#654321"/></g>,
    chef: <g><ellipse cx="50" cy="12" rx="14" ry="8" fill="white" stroke={C.forest} strokeWidth="1"/><ellipse cx="50" cy="6" rx="10" ry="7" fill="white"/><ellipse cx="50" cy="1" rx="7" ry="5" fill="white"/></g>,
    detective: <g><ellipse cx="50" cy="14" rx="18" ry="5" fill="#654321"/><ellipse cx="50" cy="9" rx="14" ry="8" fill="#654321"/><ellipse cx="50" cy="11" rx="10" ry="5" fill="#8B4513"/></g>,
    viking: <g><ellipse cx="50" cy="14" rx="16" ry="6" fill="#888"/><circle cx="34" cy="10" r="5" fill="#888"/><circle cx="66" cy="10" r="5" fill="#888"/><path d="M34,10 Q32,2 35,0" fill="none" stroke="#888" strokeWidth="2.5"/><path d="M66,10 Q68,2 65,0" fill="none" stroke="#888" strokeWidth="2.5"/></g>,
    pirate: <g><ellipse cx="50" cy="14" rx="16" ry="5" fill="#1a1a1a"/><rect x="34" y="9" width="32" height="6" fill="#1a1a1a"/><rect x="45" y="5" width="10" height="5" fill="#1a1a1a"/><circle cx="50" cy="12" r="3" fill="white"/><circle cx="50" cy="12" r="1.5" fill="#1a1a1a"/></g>,
    alien: <g><ellipse cx="40" cy="10" rx="7" ry="10" fill={C.lime}/><ellipse cx="60" cy="10" rx="7" ry="10" fill={C.lime}/><circle cx="40" cy="9" r="3" fill="#1a1a1a"/><circle cx="60" cy="9" r="3" fill="#1a1a1a"/></g>,
    unicorn: <g><polygon points="50,-2 47,16 53,16" fill={C.gold}/><ellipse cx="43" cy="10" rx="5" ry="3" fill={C.pink}/><ellipse cx="57" cy="10" rx="5" ry="3" fill={C.purple}/></g>,
  };
    ...
    <svg width={size} height={size} viewBox="0 0 100 100" onClick={onClick} style={{ cursor: onClick ? 'pointer' : 'default' }}>
      ...
      {showMotion && (
        <g stroke={C.forest} strokeWidth="2" strokeLinecap="round" opacity="0.4">
          <path d="M12,55 Q8,55 5,52" fill="none"/>
          <path d="M10,62 Q5,62 2,60" fill="none"/>
          <path d="M12,69 Q8,70 5,72" fill="none"/>
        </g>
      )}
      
      {/* Goose body - rounder like logo */}
      <ellipse cx="52" cy="62" rx="26" ry="24" fill={color} stroke={C.forest} strokeWidth="2.5"/>
      
      {/* Wing curve */}
      <path d="M34,55 Q28,65 36,75" fill="none" stroke={C.forest} strokeWidth="2" strokeLinecap="round" opacity="0.3"/>
      
      {/* Goose neck - curved like logo */}
      <path d="M58,42 C62,32 58,22 52,18" fill="none" stroke={color} strokeWidth="14" strokeLinecap="round"/>
      
      {/* Goose head - rounder */}
      <circle cx="50" cy="22" r="13" fill={color} stroke={C.forest} strokeWidth="2.5"/>
      
      {/* Beak - pointier like logo */}
      <path d="M62,24 L78,26 L62,28 Z" fill={C.orange}/>
      <path d="M62,24 L75,25.5 L62,26.5 Z" fill="#ffaa00"/>
      
      {/* Eye based on mood */}
      {mood === 'happy' ? (
        <path d="M44,20 Q48,26 52,20" fill="none" stroke={C.forest} strokeWidth="2.5" strokeLinecap="round"/>
      ) : mood === 'energized' ? (
        <>
          <circle cx="48" cy="22" r="5" fill={C.forest}/>
          <circle cx="49" cy="20" r="2" fill="white"/>
        </>
      ) : (
        <>
          <circle cx="48" cy="22" r="4" fill={C.forest}/>
          <circle cx="49" cy="21" r="1.5" fill="white"/>
        </>
      )}
      
      {/* Goose feet - orange like logo */}
      <ellipse cx="40" cy="88" rx="10" ry="4" fill={C.orange}/>
      <ellipse cx="60" cy="88" rx="10" ry="4" fill={C.orange}/>
...
const spotifyPlaylists = [
  { id: 'focus', name: 'Focus Flow', emoji: '🎯', uri: 'spotify:playlist:37i9dQZF1DWZeKCadgRdKQ' },
  { id: 'chill', name: 'Chill Vibes', emoji: '😌', uri: 'spotify:playlist:37i9dQZF1DX4WYpdgoIcn6' },
  { id: 'energy', name: 'Energy Boost', emoji: '⚡', uri: 'spotify:playlist:37i9dQZF1DX8NTLI2TtZa6' },
  { id: 'indie', name: 'Indie Mix', emoji: '🎸', uri: 'spotify:playlist:37i9dQZF1DX2Nc3B70tvx0' },
  { id: 'sleep', name: 'Sleep', emoji: '😴', uri: 'spotify:playlist:37i9dQZF1DWZd79rJ6a7lp' },
];
...
const DEFAULT_RESTAURANTS = [
  ...
  { id: 'petra', name: 'Petra and the Beast', cuisine: 'Farm to Table', price: '$$$', neighborhood: 'Deep Ellum', mustOrder: 'Chef\'s choice', bookOn: 'Resy', lastVisit: null },
  ...
  { id: 'ellie', name: 'Ellie\'s', cuisine: 'American', price: '$$$$', neighborhood: 'Design District', mustOrder: 'Dover sole', bookOn: 'Resy', lastVisit: null },
];

const cuisineTypes = ['Any', 'Japanese', 'Italian', 'Mexican', 'French', 'American', 'Thai', 'Indian', 'Mediterranean', 'Korean'];
...
const chuckAccessories = [
  ...
  { id: 'bow', name: 'Bow', price: 30, emoji: '🎀' },
  { id: 'beret', name: 'Beret', price: 40, emoji: '🎨' },
  { id: 'gradcap', name: 'Grad Cap', price: 50, emoji: '🎓' },
  { id: 'glasses', name: 'Glasses', price: 25, emoji: '👓' },
  { id: 'headphones', name: 'Headphones', price: 45, emoji: '🎧' },
  { id: 'halo', name: 'Halo', price: 60, emoji: '😇' },
  { id: 'horns', name: 'Horns', price: 66, emoji: '😈' },
  // Seasonal
  { id: 'santa', name: 'Santa Hat', price: 50, emoji: '🎅' },
  { id: 'witch', name: 'Witch Hat', price: 45, emoji: '🧙‍♀️' },
  { id: 'bunny', name: 'Bunny Ears', price: 35, emoji: '🐰' },
  { id: 'turkey', name: 'Turkey', price: 40, emoji: '🦃' },
  { id: 'shamrock', name: 'Shamrock', price: 30, emoji: '☘️' },
  { id: 'party', name: 'Party Hat', price: 25, emoji: '🎉' },
  // Funny
  { id: 'cowboy', name: 'Cowboy', price: 55, emoji: '🤠' },
  { id: 'chef', name: 'Chef Hat', price: 40, emoji: '👨‍🍳' },
  { id: 'detective', name: 'Detective', price: 50, emoji: '🕵️' },
  { id: 'viking', name: 'Viking', price: 70, emoji: '⚔️' },
  { id: 'pirate', name: 'Pirate', price: 60, emoji: '🏴‍☠️' },
  { id: 'alien', name: 'Alien', price: 80, emoji: '👽' },
  { id: 'unicorn', name: 'Unicorn', price: 75, emoji: '🦄' },
];
const chuckSnacks = [
  ...
  if (showSplash) {
    return (
      <div style={{ 
        ...
        <div style={{ marginTop: 40, opacity: 0.5, fontSize: 12, animation: 'bounce 1s ease-in-out infinite' }}>
          🪿 Loading your goose...
        </div>
      </div>
    );
    ...
    <div style={{ fontFamily: 'system-ui, sans-serif', background: C.cream, color: C.forest, minHeight: '100vh' }}>
          ...
          <div style={{ background: `linear-gradient(180deg, ${C.limePale} 0%, ${C.cream} 100%)`, minHeight: '70vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 20, position: 'relative' }}>
            ...
            <div style={{ marginTop: 24, zIndex: 1, width: '100%', maxWidth: 280 }}>
              <div style={{ 
                ...
                <div style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: C.lime, marginBottom: 8 }}>
                ...
                {pomodoroCount > 0 && (
                  <div style={{ marginTop: 12, fontSize: 11, color: C.lime }}>
                    🍅 {pomodoroCount} pomodoro{pomodoroCount > 1 ? 's' : ''} today! (+{pomodoroCount * 25} coins)
                  </div>
                )}
              </div>
            </div>
      ...
      {page === 'music' && (
        <div style={{ padding: 20 }}>
          ...
          <div style={{ marginTop: 24, padding: 16, background: `${C.lime}20`, borderRadius: 12, textAlign: 'center' }}>
            <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 8 }}>🎵 Pro tip</div>
      ...
      {page === 'datenight' && (
        <div style={{ padding: 20 }}>
          <h2 style={{ fontSize: 22, margin: '0 0 8px' }}>Date Night 💕</h2>
          <p style={{ fontSize: 12, opacity: 0.6, marginBottom: 20 }}>Find the perfect spot & don't forget to book early!</p>
          ...
          <Card color={C.pink} style={{ marginBottom: 16, textAlign: 'center' }}>
            <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 12, color: C.pink }}>✨ SURPRISE ME</div>
            ...
            {dateNightPick ? (
              <div>
                ...
                {dateNightPick.mustOrder && (
                  <div style={{ fontSize: 11, marginTop: 8, padding: '8px 12px', background: `${C.gold}20`, borderRadius: 8 }}>
                    ⭐ Must try: {dateNightPick.mustOrder}
                  </div>
                )}
            ...
            <Card key={r.id} style={{ marginBottom: 10 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                  ...
                  {r.mustOrder && <div style={{ fontSize: 10, color: C.gold, marginTop: 4 }}>⭐ {r.mustOrder}</div>}
                </div>
